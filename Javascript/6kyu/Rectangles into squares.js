...
function sqInRect(lng, wdth){
    //A square with the shortest side will always fit into the rect
    //Find Area
    //Subtract these sides
    //Use these sides to find next square
    //Repeat until length, width == 0
    if (lng==wdth){
      return null;
    }
    let side = 0;
