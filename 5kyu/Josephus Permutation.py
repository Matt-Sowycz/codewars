...
#Shifts index of k to match array syntax (1,2,3,n) => (0,1,2, n-1)
#If the index is out of bounds due to popping of elements within the array, loop the index back around
#continue popping until input array has length of zero
